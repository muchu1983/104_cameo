...
class ImporterForTECHCRUNCH:
    ...
    def importNewsJsonToDb(self, uselessArg1=None):
        strNewsJsonFolderPath = self.PARSED_RESULT_BASE_FOLDER_PATH + u"\\TECHCRUNCH\\news"
        lstStrNewsJsonFilePath = self.utility.getFilePathListWithSuffixes(strBasedir=strNewsJsonFolderPath, strSuffixes="news.json")
