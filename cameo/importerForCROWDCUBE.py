...
class ImporterForCROWDCUBE:
    ...
    def importStartupJson(self):
        ...
        for strUrl, dicStartup in dicTotalStartup.items():
            #strSource
            dicStartup.setdefault("strSource", "CROWDCUBE")
            #strCrawlTime
    ...
    def strParsedResultPath(self):
        return u"cameo_res/parsed_result/CROWDCUBE"
    
    #取得 startup.json 檔案位置
    def getParsedStartupFilePath(self):
        return self.strParsedResultPath() + "/companies/startup.json"
